...
const REDIRECTS = {
  ...
  '/east-bay-mobile-carb-testing': '/bay-area-mobile-carb',
  '/clean-truck-check-bay-area': '/bay-area-mobile-carb',
  '/tracy-livermore-clean-truck-check-j1667': '/stockton-clean-truck-check',
  '/clean-truck-check-fresno': '/areas#central-valley',
  '/clean-truck-check-hayward': '/bay-area-mobile-carb',
  '/service-area-butte-county-clean-truck-check': '/areas#butte',
  '/service-area-san-joaquin-county-mobile-testing': '/areas#san-joaquin',
  '/san-jose-mobile-carb-testing': '/bay-area-mobile-carb',
