...
const REDIRECTS = {
  ...
  '/east-bay-mobile-carb-testing': '/hayward-tracy-carb-testing',
  '/clean-truck-check-bay-area': '/areas#bay-area',
  '/tracy-livermore-clean-truck-check-j1667': '/hayward-tracy-carb-testing',
  '/clean-truck-check-fresno': '/areas#central-valley',
  '/clean-truck-check-hayward': '/hayward-tracy-carb-testing',
