...
## 1) Google Business Profile — DONE (owner)

Photos / update already posted on the listing.
...
## 3) Facebook (optional — paste if not posted yet)
...
Attach the same Mojave photos used on Google Business Profile.
