...
## Testing notes from Sacramento-area yards

The usual construction visit is a mixed lot, not a single class of truck.

- Mixer / dump / service truck on one appointment is normal.
- F550-class units show up on the same Friday window as heavier iron. That is why the published Plaster Group story exists: deadline pressure is a calendar problem, not a shop problem. Read [Plaster Group F550](/clean-truck-check-blog/when-friday-deadline-pressure-hits-how-norcal-carb-mobile-kept-the-plaster-groups-f550-fleet-compliant).
- Two OBD tests on one construction account is a documented pattern (Mitchell Concrete, Rancho Cordova / Granite Bay corridor). See [Mitchell Concrete](/clean-truck-check-blog/how-norcal-carb-mobile-keeps-mitchell-concrete-moving-strong-in-rancho-cordova).
- Dawn fencing and early concrete starts are why Saturday and jobsite staging appointments exist. Castillo Fencing is the published dawn example: [Castillo Fencing](/clean-truck-check-blog/keeping-castillo-fencings-fleet-rolling-before-sunrise).

We confirm OBD vs OVI from engine year / equipment **before** dispatch. Unsure units get a VIN check on the call, not a guessed test type at the gate.
...
1. Yard or jobsite address in Sacramento County or the foothills loop.
2. Unit count and engine years (or VINs).
3. Whether the trucks are already in CTC-VIS.
