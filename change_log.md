...
- `/areas` Where we test is six cards: Sacramento (+ foothills), Bay Area, Napa to Livermore (`/napa-sonoma-carb-testing`; Livermore `/contact`), San Jose South Bay and East Bay (`/bay-area-mobile-carb`), Butte (+ Santa Rosa on `/napa-sonoma-carb-testing`). No new city pages. Hub Related field notes includes the Bayshore post.
